...
//                .andExpect(jsonPath("$.data[0].lineId").value("line1"))
//                .andExpect(jsonPath("$.data[0].processId").value("process1"))
//                .andExpect(jsonPath("$.data[0].serialNumber").value("serial1"))
//                .andExpect(jsonPath("$.data[0].plannedDate").value("2024-12-12T00:00:00"))
//                .andExpect(jsonPath("$.data[0].estimatedTime").value(1));
//    }
//
//    @Test
